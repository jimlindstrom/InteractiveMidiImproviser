...
describe Midi::EventQueue do
  ...
  describe "#get_interonset_intervals" do
    it "returns an IOIArray" do
      @evq = Midi::EventQueue.new
      @evq.enqueue({:message=>[Midi::Event::NOTE_ON, 40,100,0],:timestamp=>1000})
      @evq.enqueue({:message=>[Midi::Event::NOTE_OFF,40,100,0],:timestamp=>2000})
      @evq.enqueue({:message=>[Midi::Event::NOTE_ON, 40,100,0],:timestamp=>2000})
      @evq.enqueue({:message=>[Midi::Event::NOTE_OFF,40,100,0],:timestamp=>3000})
      @evq.enqueue({:message=>[Midi::Event::NOTE_ON, 40,100,0],:timestamp=>3000})
      @evq.enqueue({:message=>[Midi::Event::NOTE_OFF,40,100,0],:timestamp=>4000})

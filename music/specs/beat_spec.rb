...
describe Music::Beat do
  ...
  context "similarity_to" do
    ...
    it "should return 0.0 when compared to a radically different duration" do
      n0 = Music::Note.new(Music::Pitch.new(50), Music::Duration.new(2))
      n1 = Music::Note.new(Music::Pitch.new(52), Music::Duration.new(1))
      b = Music::Beat.new
      b.prev_note = n0
      b.cur_note  = n1
    ...
    it "should return 1.0 when compared to itself" do
      n0 = Music::Note.new(Music::Pitch.new(50), Music::Duration.new(1))
      n1 = Music::Note.new(Music::Pitch.new(50), Music::Duration.new(1))
      b = Music::Beat.new
      b.prev_note = n0
      b.cur_note  = n1

...
describe Music::Meter do
  ...
  context "new" do
    before(:each) do
      ...
      @beat_unit         = 4
      @subbeats_per_beat = 2 # expressed in eight notes
    end
    it "should take 3 values: beats/measure, a beat unit, and subbeats/beat" do
      Music::Meter.new(@beats_per_measure, @beat_unit, @subbeats_per_beat).should be_an_instance_of Music::Meter
    end
    ...
    it "should take subbeats/beat of 1, 2, or 4" do
      @subbeats_per_beat = 1 # expressed in the beat unit
      Music::Meter.new(@beats_per_measure, @beat_unit, @subbeats_per_beat).should be_an_instance_of Music::Meter
    end
    it "should take subbeats/beat of 1, 2, or 4" do
      @subbeats_per_beat = 4 # expressed 4ths of the beat unit
      Music::Meter.new(@beats_per_measure, @beat_unit, @subbeats_per_beat).should be_an_instance_of Music::Meter
    end

    it "raise an error on invalid parameters" do
      lambdas = []
      lambdas.push lambda { Music::Meter.new(1,                  @beat_unit, @subbeats_per_beat) }
      lambdas.push lambda { Music::Meter.new(7,                  @beat_unit, @subbeats_per_beat) }
      lambdas.push lambda { Music::Meter.new(@beats_per_measure, 1,          @subbeats_per_beat) }
      lambdas.push lambda { Music::Meter.new(@beats_per_measure, 3,          @subbeats_per_beat) }
      lambdas.push lambda { Music::Meter.new(@beats_per_measure, 5,          @subbeats_per_beat) }
      lambdas.push lambda { Music::Meter.new(@beats_per_measure, 6,          @subbeats_per_beat) }
      lambdas.push lambda { Music::Meter.new(@beats_per_measure, 7,          @subbeats_per_beat) }
      lambdas.push lambda { Music::Meter.new(@beats_per_measure, 9,          @subbeats_per_beat) }
  ...
  context "beats_per_measure" do
    it "should get the number of beats per measure" do
      @beats_per_measure = 2 # 3/4 time
      @beat_unit         = 2
      @subbeats_per_beat = 1 # expressed in eight notes
  ...
  context "subbeats_per_beat" do
    it "should get number of subbeats per beat" do
      @beats_per_measure = 2 # 3/4 time
      @beat_unit         = 2
      @subbeats_per_beat = 1 # expressed in eight notes
      m = Music::Meter.new(@beats_per_measure, @beat_unit, @subbeats_per_beat)
      m.subbeats_per_beat.should equal 1
    end
  end
  ...
  context "val" do
    it "should return all values" do
      ...
      @subbeats_per_beat = 1 # expressed in eight notes
      m = Music::Meter.new(@beats_per_measure, @beat_unit, @subbeats_per_beat)
      m.val.should == {:beats_per_measure => 2, :beat_unit => 2, :subbeats_per_beat => 1}
    end
  end
